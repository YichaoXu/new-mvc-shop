                                        ...
                                        <?php foreach ($list_user as $user) : ?>
                                            <tr>
                                                ...
                                                <td><a href="admin.php?controller=user&amp;action=info&amp;user_id=<?= $user['id']; ?>" class="btn btn-success waves-effect waves-float btn-sm waves-green"><i class="zmdi zmdi-eye"></i></a>
                                                    ...
                                                    <a onclick="return confirm('Are you sure to delete?')" href="admin.php?controller=user&amp;action=delete&amp;user_id=<?= $user['id']; ?>" class="btn btn-danger waves-effect waves-float btn-sm waves-red"><i class="zmdi zmdi-delete"></i></a></td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                </table>
